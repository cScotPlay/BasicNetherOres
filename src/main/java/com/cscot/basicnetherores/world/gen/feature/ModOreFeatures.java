...
public class ModOreFeatures
{
    ...
    public static ConfiguredFeature<?, ?> ORE_EMERALD_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netheremerald_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_DIAMOND_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netherdiamond_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_REDSTONE_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netherredstone_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_LAPIS_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netherlapis_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_COAL_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.nethercoal_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_SILVER_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.nethersilver_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_IRON_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netheriron_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_LEAD_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netherlead_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_NICKEL_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.nethernickel_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_COPPER_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.nethercopper_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_ALUMINUM_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netheraluminum_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_TIN_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.nethertin_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_OSMIUM_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netherosmium_ore.getDefaultState(),
    ...
    public static ConfiguredFeature<?, ?> ORE_URANIUM_NETHER = Feature.ORE
            .withConfiguration(new OreFeatureConfig(
                    OreFeatureConfig.FillerBlockType.NETHERRACK, BlockOreList.netheruranium_ore.getDefaultState(),
    ...
    {
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_emerald_nether"), ORE_EMERALD_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_diamond_nether"), ORE_DIAMOND_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_redstone_nether"), ORE_REDSTONE_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_lapis_nether"), ORE_LAPIS_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_coal_nether"), ORE_COAL_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_silver_nether"), ORE_SILVER_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_iron_nether"), ORE_IRON_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_lead_nether"), ORE_LEAD_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_nickel_nether"), ORE_NICKEL_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_copper_nether"), ORE_COPPER_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_aluminum_nether"), ORE_ALUMINUM_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_tin_nether"), ORE_TIN_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_osmium_nether"), ORE_OSMIUM_NETHER);
        Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(modID, "ore_uranium_nether"), ORE_URANIUM_NETHER);
    }
